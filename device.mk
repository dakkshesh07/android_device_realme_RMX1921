...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/bluetooth_audio_policy_configuration_7_0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth_audio_policy_configuration.xml
...
PRODUCT_COPY_FILES += \
    ...
    frameworks/av/services/audiopolicy/config/hearing_aid_audio_policy_configuration_7_0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth_hearing_aid_audio_policy_configuration.xml
...
PRODUCT_COPY_FILES += \
    ...
    device/qcom/common/vendor/seccomp/mediaextractor-seccomp.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/mediaextractor-seccomp.policy \
    hardware/qcom-caf/sdm845/media/conf_files/sdm845/system_properties.xml:$(TARGET_COPY_OUT_VENDOR)/etc/system_properties.xml
...
# Power
PRODUCT_PACKAGES += \
    android.hardware.power-service.RMX1921-libperfmgr
